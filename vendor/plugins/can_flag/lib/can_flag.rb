    ...
    module Flag
      ...
      module ClassMethods
        ...
        def can_flag
          ...
          has_many :flags, :as => :flagger, :order => "id desc"
          
          # User was responsible for creating this filth
          has_many :flaggings, :as => :owner, :class_name => "Flag"
          ...
          ::Flag.class_eval "belongs_to :flagger, :polymorphic => true; 
