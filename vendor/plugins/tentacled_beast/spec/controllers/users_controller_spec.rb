...
#     groups(:default).users.authenticate(users(:pending).login, 'test').should be_nil
#     get :activate, :activation_code => users(:pending).activation_code
#     response.should redirect_to('/')
#     groups(:default).users.authenticate(users(:pending).login, 'test').should == users(:pending)
...
#     assigns[:current_user].group.should == groups(:default)
